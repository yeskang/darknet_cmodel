...
{
    if(l.type == BATCHNORM)
		copy_gpu(l.outputs*l.batch, net.input_gpu, 1, l.output_gpu, 1); // net.input_gpu -> l.output_gpu
    copy_gpu(l.outputs*l.batch, l.output_gpu, 1, l.x_gpu, 1);			// l.output_gpu  -> l.x_gpu
    if (net.train) {
#ifdef CUDNN
        float one = 1;
        float zero = 0;
